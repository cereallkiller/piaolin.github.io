...
<head>
    ...
    <link href="/520/<?php $this->options->themeUrl('style.min.css'); ?>" rel="stylesheet">
	<!--[if lt IE 9]>
	...
	<div class="container grid-sm s-content header">
		<div class="column col-12">
			...
			<p class="description">这里记录了 <a href="#" target="_blank">@李逍遥</a> 和 <a href="#" target="_blank">@杨月月</a> 相爱的100件事。<br>相信我们还会留下更多美好的回忆，查看之前的 <a href="<?php $this->options->message() ?>">点滴</a> ！</p>
		</div>
	</div>